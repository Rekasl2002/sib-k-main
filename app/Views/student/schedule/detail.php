<!-- app/Views/student/schedule/detail.php -->
...
<div class="page-content">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <a href="<?= base_url('student/schedule') ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <?php
      ...
      // Page ini hanya dipanggil kalau sesi tidak rahasia, jadi default true aman
      ...
      <div class="card-body">
        <?php if (!$canSeeNotes): ?>
          <div class="alert alert-warning mb-0">
            ...
            Ringkasan dan catatan sesi tidak ditampilkan di portal siswa.
          </div>
        <?php else: ?>
          <div class="mb-3">
    ...
    <?php if ($showParticipation): ?>
      <!-- Catatan Partisipasi Saya -->
      <div class="card mb-3">
        <div class="card-header">
          <strong>Catatan Partisipasi Saya</strong>
        </div>
        <div class="card-body">
          <?php if (!$canSeeNotes): ?>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <?php else: ?>
          ...
          <?php else: ?>
            <p class="mb-0 text-muted fst-italic">
              Belum ada catatan sesi yang dapat ditampilkan untuk siswa.
            </p>
          <?php endif; ?>
        <?php endif; ?>
      </div>
