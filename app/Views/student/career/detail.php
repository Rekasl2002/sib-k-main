<?php // app/Views/student/career/detail.php ?>
...
$links        = $links ?? [];
$related      = $related ?? [];
$universities = $universities ?? []; // disiapkan, tapi tidak dipakai lagi
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
            ...
            <div class="row g-2">
              <?php foreach ($related as $relRaw): ?>
                ...
                <div class="col-12 col-md-6">
                  <a href="<?= site_url('student/career/' . (int) ($rel['id'] ?? 0)) ?>"
      ...
      <div class="mb-3">
        <a href="<?= site_url('student/career') ?>" class="btn btn-light">
