<!-- app/Views/parent/child/sessions_history.php -->
...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0">Riwayat Jadwal Konseling</h4>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div>
            <h5 class="card-title mb-1">
              Riwayat Jadwal Konseling
            </h5>
            <p class="text-muted mb-0">
              Anak: <span class="fw-semibold"><?= esc($studentName) ?></span>
            </p>
          </div>
          <div class="text-end">
            <a href="<?= route_to('parent.children.sessions', $studentId) ?>"
              ...
              <?php if (!empty($history) && is_array($history)): ?>
                <?php foreach ($history as $row): ?>
                  ...
                  >
                    ...
                    <td>
                      <a href="<?= route_to(
                        'parent.children.sessions.detail',
                        $studentId,
                        $sessionId
                      ) ?>"
