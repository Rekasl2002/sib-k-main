  ...
  <div class="row">
    <?php
      $miniCards = [
        ...
        ['label' => 'Karier Tersimpan Anak',      'value' => count($savedCareerIds),                                              'bg' => 'bg-success',   'icon' => 'mdi-bookmark-check'],
        ...
        ['label' => 'PT Tersimpan Anak',          'value' => count($savedUniversityIds),                                          'bg' => 'bg-secondary', 'icon' => 'mdi-bookmark-check'],
      ];
    ?>
