<!-- app/Views/parent/violations/index.php -->
...
$categoriesUrl = $studentId
    ? base_url('parent/child/' . $studentId . '/violations/categories')
    : null;
?>
    ...
    <div class="row mb-3">
      <div class="col-12 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-2">
          <div>
            <h4 class="mb-0">Riwayat Pelanggaran Anak</h4>
            <?php if ($studentName): ?>
          ...
          <?php if ($categoriesUrl): ?>
            <a href="<?= esc($categoriesUrl) ?>"
        ...
        <div class="card mb-0" style="min-width: 260px;">
          <div class="card-body py-2 px-3 d-flex justify-content-between align-items-center">
            <div>
              <div class="text-muted small">Total Poin Pelanggaran Anak</div>
        ...
        <?php if (empty($violations)): ?>
          <div class="text-center py-4">
            ...
            <p class="text-muted mb-0 mt-2">
              Tidak ada pelanggaran yang tercatat untuk anak ini. Pertahankan ya! 🎉
            </p>
          </div>
        <?php else: ?>
            ...
            <table class="table table-striped align-middle">
              ...
              <?php foreach ($violations as $v): ?>
                ...
                <tr>
                  ...
                  <td><?= esc($recorder) ?></td>
                  <td>
                    <?php if ($id > 0 && $studentId): ?>
                      <a href="<?= base_url('parent/child/' . $studentId . '/violations/' . $id) ?>"
