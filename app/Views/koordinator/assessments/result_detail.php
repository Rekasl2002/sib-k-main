<?php
/**
 * File: app/Views/koordinator/assessments/result_detail.php
...
<div class="d-flex align-items-center justify-content-between mb-3" id="top">
  ...
  <div class="text-end d-flex gap-2">
    <?php if ($status === 'Graded'): ?>
      <form method="post" action="<?= site_url("koordinator/assessments/{$assessmentId}/results/{$resultId}/ungrade") ?>">
        <?= csrf_field() ?>
    ...
    <a href="<?= site_url("koordinator/assessments/{$assessmentId}/results") ?>" class="btn btn-outline-secondary">
...
<div class="card mb-3" id="review">
  ...
  <div class="card-body">
    <form method="post" action="<?= site_url('koordinator/assessments/grade/submit') ?>">
      <?= csrf_field() ?>
      ...
      <div class="mt-3 d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary" href="<?= site_url("koordinator/assessments/{$assessmentId}/results") ?>">
          Kembali
        </a>
          ...
          <div class="list-group-item qa-item" data-state="<?= h($state) ?>">
            <div class="d-flex justify-content-between align-items-start">
              ...
              <div class="text-end" style="min-width:260px">
                ...
                <?php if ($ansId): ?>
                  <hr class="my-2">
                  <form method="post" action="<?= site_url('koordinator/assessments/grade/answer') ?>" class="qa-grade-form">
                    <?= csrf_field() ?>
