  ...
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      ...
      <div class="d-flex gap-2 flex-wrap mt-2 mt-sm-0 align-items-center">
        ...
        <a class="btn btn-outline-secondary btn-sm" href="<?= site_url('koordinator/assessments') ?>">
...
<div class="card mb-3 border-0 shadow-sm">
  ...
  <div class="card-body">
    <form method="post"
          action="<?= site_url('koordinator/assessments/'.$assessment['id'].'/questions/add') ?>"
          id="questionForm"
      ...
      <div class="mt-3 d-flex gap-2">
        ...
        <a class="btn btn-secondary btn-sm" href="<?= site_url('koordinator/assessments') ?>">
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group btn-group-sm" role="group">
                    ...
                    <!-- Delete -->
                    <form method="post"
                          action="<?= site_url('koordinator/assessments/'.$assessment['id'].'/questions/'.$q['id'].'/delete') ?>"
                          class="d-inline"
  ...
  (function(){
    ...
    document.addEventListener('click', function(e){
      ...
      if (editBtn){
        ...
        const base   = "<?= site_url('koordinator/assessments/'.$assessment['id'].'/questions') ?>";
