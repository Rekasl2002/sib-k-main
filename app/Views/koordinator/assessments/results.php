    ...
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-2 flex-wrap mt-2 mt-sm-0">
                ...
                <a href="<?= site_url('koordinator/assessments/'.$assessmentId.'/assign') ?>" class="btn btn-outline-primary">
                    <i class="mdi mdi-account-plus me-1"></i> Tugaskan
                </a>
                <form method="post" action="<?= site_url('koordinator/assessments/'.$assessmentId.'/assign/sync') ?>" class="d-inline">
                    <?= csrf_field() ?>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="get" action="<?= base_url('koordinator/assessments/' . $assessmentId . '/results') ?>">
            <div class="row g-3">
                <div class="col-md-3">
            ...
            <div class="mt-3 d-flex flex-wrap gap-2">
                ...
                <a href="<?= base_url('koordinator/assessments/' . $assessmentId . '/results') ?>" class="btn btn-secondary">
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body pt-0">
        ...
        <div class="d-flex justify-content-between align-items-center py-3">
            ...
            <form id="bulkRevokeForm" class="d-flex gap-2" method="post" action="<?= site_url('koordinator/assessments/'.$assessmentId.'/assign/revoke') ?>">
                <?= csrf_field() ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <?php if ($resId > 0): ?>
                                            <a href="<?= site_url("koordinator/assessments/{$assessmentId}/results/{$resId}") ?>" class="btn btn-outline-primary" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <!-- Tombol hapus hasil siswa -->
                                            <form action="<?= site_url('koordinator/assessments/'.$assessmentId.'/results/'.$resId.'/delete') ?>"
                                                  method="post"
                                                  class="d-inline"
                                            ...
                                            <?php if ($status === 'Completed'): ?>
                                                <a href="<?= site_url("koordinator/assessments/{$assessmentId}/results/{$resId}") ?>#review" class="btn btn-warning" title="Nilai Jawaban">
                                                    <i class="fas fa-check"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if ($status === 'Graded'): ?>
                                                <form method="post" action="<?= site_url("koordinator/assessments/{$assessmentId}/results/{$resId}/ungrade") ?>" class="d-inline">
                                                    <?= csrf_field() ?>
