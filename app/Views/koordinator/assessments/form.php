<?php
/**
 * File: app/Views/koordinator/assessments/form.php
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      ...
      <div class="d-flex gap-2 flex-wrap mt-2 mt-sm-0 align-items-center">
        ...
        <?php if ($method === 'edit' && ! empty($A['id'])): ?>
          ...
          <a class="btn btn-sm btn-outline-success" href="<?= site_url('koordinator/assessments/' . (int) $A['id'] . '/assign') ?>">
            <i class="mdi mdi-account-plus me-1"></i> Tugaskan
          </a>
        <?php endif; ?>
        <a href="<?= site_url('koordinator/assessments') ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="card-body">
        <form method="post" action="<?= $action ?>" novalidate>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                ...
                <div class="text-end">
                    <a href="<?= site_url('koordinator/assessments') ?>" class="btn btn-outline-secondary">
                        Batal
                    </a>
