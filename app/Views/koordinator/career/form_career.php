<?php
/**
 * File Path: app/Views/koordinator/career/form_career.php
 *
 * Variabel:
 * - $career (array|null)
 * - $errors (array)
...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <div class="d-flex align-items-center flex-wrap gap-3 page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="<?= site_url('koordinator/career-info?tab=careers') ?>">Info Karier dan Studi Lanjut</a></li>
            <li class="breadcrumb-item active"><?= $isEdit ? 'Edit' : 'Tambah' ?></li>
        </ol>
        <a href="<?= site_url('koordinator/career-info?tab=careers') ?>" class="btn btn-sm btn-secondary">
            &larr; Kembali
        </a>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form method="post"
              action="<?= $isEdit
                  ? route_to('koordinator.career.update', $career['id'])
                  : route_to('koordinator.career.store') ?>">
