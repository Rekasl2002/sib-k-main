<?php
/**
 * File Path: app/Views/koordinator/career/form_university.php
 *
 * Vars:
...
<div class="d-flex align-items-center justify-content-between mb-3">
  ...
  <div class="d-flex align-items-center flex-wrap gap-3 page-title-right">
    <ol class="breadcrumb m-0">
      ...
      <li class="breadcrumb-item"><a href="<?= site_url('koordinator/career-info/universities?tab=universities') ?>">Info Karier dan Studi Lanjut</a></li>
      <li class="breadcrumb-item active"><?= $isEdit ? 'Edit' : 'Tambah' ?></li>
    </ol>
    <a href="<?= site_url('koordinator/career-info/universities?tab=universities') ?>" class="btn btn-sm btn-secondary">
      &larr; Kembali
    </a>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    <form method="post"
          action="<?= $isEdit
              ? route_to('koordinator.university.update', (int)($career['id'] ?? 0))
              : route_to('koordinator.university.store') ?>"
      ...
      <!-- Status tampil/sembunyi ke siswa & orang tua -->
      <div class="mb-3">
        ...
        <div class="form-text">Pilih "Ditampilkan" agar perguruan tinggi ini muncul di portal siswa &amp; orang tua.</div>
