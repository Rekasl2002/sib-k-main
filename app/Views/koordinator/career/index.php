...
<ul class="nav nav-tabs nav-tabs-custom mb-3" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link <?= ($activeTab === 'universities' ? 'active' : '') ?>"
           href="<?= site_url('koordinator/career-info?tab=universities') ?>">
                    ...
                    <div class="card-body py-3">
                        <form action="<?= site_url('koordinator/career-info') ?>" method="get">
                            ...
                            <div class="row mt-2 g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label d-block">&nbsp;</label>
                                    <a href="<?= site_url('koordinator/career-info?tab=careers') ?>" class="btn btn-secondary w-100"><i class="mdi mdi-refresh me-1"></i> Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body py-3">
                        <form action="<?= site_url('koordinator/career-info') ?>" method="get">
                            ...
                            <div class="row mt-2 g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label d-block">&nbsp;</label>
                                    <a href="<?= site_url('koordinator/career-info?tab=universities') ?>" class="btn btn-secondary w-100"><i class="mdi mdi-refresh me-1"></i> Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
