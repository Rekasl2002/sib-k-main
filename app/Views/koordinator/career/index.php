 ...
 * Halaman utama Fitur Info Karier dan Info Studi Lanjut (Koordinator BK)
 *
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
  <ul class="nav nav-tabs mb-0">
    <li class="nav-item">
      <a class="nav-link <?= ($activeTab === 'careers' ? 'active' : '') ?>"
         href="<?= site_url('koordinator/career-info?tab=careers') ?>">
        <i class="mdi mdi-briefcase-outline me-1"></i>Pilihan Karier
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?= ($activeTab === 'universities' ? 'active' : '') ?>"
         href="<?= site_url('koordinator/career-info/universities?tab=universities') ?>">
  ...
  <div class="d-flex align-items-center gap-2">
    ...
    <a href="<?= route_to('koordinator.career.choices') ?>" class="btn btn-outline-secondary btn-sm shadow-sm">
      <i class="mdi mdi-account-multiple-outline me-1"></i> Pilihan Karier dan Studi Lanjut Siswa
    </a>

    <?php if ($activeTab === 'careers'): ?>
      <a href="<?= route_to('koordinator.career.create') ?>" class="btn btn-success btn-sm shadow-sm">
        <i class="mdi mdi-plus me-1"></i> Tambah Karier
      </a>
    <?php else: ?>
      <a href="<?= route_to('koordinator.university.create') ?>" class="btn btn-success btn-sm shadow-sm">
  ...
  <div class="tab-pane fade <?= ($activeTab === 'careers' ? 'show active' : '') ?>">
    <div class="card">
      <div class="card-body">
        ...
        <!-- Filter Karier -->
        <div class="mb-3">
          <form class="d-flex flex-wrap gap-2" method="get" action="<?= site_url('koordinator/career-info') ?>">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm" role="group">
                      <a href="<?= route_to('koordinator.career.edit', $c['id']) ?>"
                         class="btn btn-outline-primary" title="Edit">
                        <i class="mdi mdi-pencil"></i>
                      </a>
                      <form action="<?= route_to('koordinator.career.toggle', $c['id']) ?>"
                      ...
                      <form action="<?= route_to('koordinator.career.publish', $c['id']) ?>"
                      ...
                      <form action="<?= route_to('koordinator.career.delete', $c['id']) ?>"
  ...
  <div class="tab-pane fade <?= ($activeTab === 'universities' ? 'show active' : '') ?>">
    <div class="card">
      <div class="card-body">
        ...
        <div class="mb-3">
          <form class="d-flex flex-wrap gap-2" method="get" action="<?= site_url('koordinator/career-info/universities') ?>">
            ...
            <?php if (!empty($universities)): ?>
              <?php foreach ($universities as $u): ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm" role="group">
                      <a href="<?= route_to('koordinator.university.edit', $u['id']) ?>"
                         class="btn btn-outline-primary" title="Edit">
                        <i class="mdi mdi-pencil"></i>
                      </a>
                      <form action="<?= route_to('koordinator.university.toggle', $u['id']) ?>"
                      ...
                      <form action="<?= route_to('koordinator.university.publish', $u['id']) ?>"
                      ...
                      <form action="<?= route_to('koordinator.university.delete', $u['id']) ?>"
