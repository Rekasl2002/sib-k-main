 ...
 * Halaman utama Info Karier dan Studi Lanjut (Guru BK)
 *
...
$choicesCareerUrl = route_to('counselor.career.choices');
$choicesUniUrl    = route_to('counselor.career.choices') . '?tab=universities';
?>
            ...
            <div class="col-12">
                <div class="card filter-compact">
                    ...
                    <div class="card-body py-3">
                        <form action="<?= site_url('counselor/career-info') ?>" method="get">
                            ...
                            <div class="row mt-2 g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label d-block">&nbsp;</label>
                                    <a href="<?= site_url('counselor/career-info?tab=careers') ?>" class="btn btn-secondary w-100"><i class="mdi mdi-refresh me-1"></i> Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end d-flex gap-2 align-items-center flex-wrap">
                            ...
                            <a href="<?= route_to('counselor.career.create') ?>" class="btn btn-success">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex flex-column gap-1 align-items-stretch">
                                                    <a href="<?= route_to('counselor.career.show', $c['id']) ?>" class="btn btn-sm btn-info" title="Detail" data-bs-toggle="tooltip"><i class="mdi mdi-eye"></i></a>
                                                    <a href="<?= route_to('counselor.career.edit', $c['id']) ?>" class="btn btn-sm btn-primary" title="Edit" data-bs-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                    <form action="<?= route_to('counselor.career.toggle', $c['id']) ?>" method="post" onsubmit="return confirm('Ubah status Ditampilkan/Disembunyikan karier ini?')">
                                                        <?= csrf_field() ?>
                                                    ...
                                                    <form action="<?= route_to('counselor.career.delete', $c['id']) ?>" method="post" onsubmit="return confirm('Hapus data karier ini?')">
                                                        <?= csrf_field() ?>
                    ...
                    <div class="card-body py-3">
                        <form action="<?= site_url('counselor/career-info') ?>" method="get">
                            ...
                            <div class="row mt-2 g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label d-block">&nbsp;</label>
                                    <a href="<?= site_url('counselor/career-info?tab=universities') ?>" class="btn btn-secondary w-100"><i class="mdi mdi-refresh me-1"></i> Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end d-flex gap-2 align-items-center flex-wrap">
                            ...
                            <a href="<?= route_to('counselor.university.create') ?>" class="btn btn-success">
                                ...
                                <?php if (!empty($universities)): ?>
                                    <?php foreach ($universities as $u): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex flex-column gap-1 align-items-stretch">
                                                    <a href="<?= route_to('counselor.university.show', $u['id']) ?>" class="btn btn-sm btn-info" title="Detail" data-bs-toggle="tooltip"><i class="mdi mdi-eye"></i></a>
                                                    <a href="<?= route_to('counselor.university.edit', $u['id']) ?>" class="btn btn-sm btn-primary" title="Edit" data-bs-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                    <form action="<?= route_to('counselor.university.toggle', $u['id']) ?>" method="post" onsubmit="return confirm('Ubah status Ditampilkan/Disembunyikan perguruan tinggi ini?')">
                                                        <?= csrf_field() ?>
                                                        <button class="btn btn-sm btn-warning w-100" type="submit" title="Tampilkan/Sembunyikan" data-bs-toggle="tooltip"><i class="mdi mdi-eye-off-outline"></i></button>
                                                    </form>
                                                    <form action="<?= route_to('counselor.university.delete', $u['id']) ?>" method="post" onsubmit="return confirm('Hapus perguruan tinggi ini?')">
                                                        <?= csrf_field() ?>
                                                        <button class="btn btn-sm btn-danger w-100" type="submit" title="Hapus" data-bs-toggle="tooltip"><i class="mdi mdi-delete"></i></button>
                                                    </form>
                                                </div>
