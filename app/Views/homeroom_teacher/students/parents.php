        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url('homeroom/my-class') ?>" class="btn btn-secondary">
                        <i class="mdi mdi-arrow-left me-1"></i>Kelas Binaan
                    </a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        ...
                                        <p class="text-dark mt-2 mb-0">Belum ada akun orang tua yang terhubung dengan siswa kelas binaan Anda.</p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
