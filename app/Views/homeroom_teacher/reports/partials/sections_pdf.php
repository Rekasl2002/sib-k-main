<?php
/**
 * File Path: app/Views/homeroom_teacher/reports/partials/sections_pdf.php
 * Wali Kelas • PDF Laporan multi-fitur (server-side, Dompdf) — garis besar aman.
 */
$sections    = $sections    ?? [];
$reportTitle = $reportTitle ?? 'Laporan Kelas (Wali Kelas)';
...
<body>
  <div class="box">
    ...
    <div class="muted">
      ...
      <i>Catatan rahasia konseling &amp; skor asesmen individu tidak ditampilkan.</i>
    </div>
  </div>
