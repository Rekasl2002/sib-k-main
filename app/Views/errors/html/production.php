...
<head>
  ...
  <style>
    :root{--p:#1f6f54;--p2:#0f3b2c;--p3:#082318;--a:#d1a545;--t:#0f172a;--sh:0 18px 55px rgba(2,8,6,.35);--r:22px}
    *{box-sizing:border-box}
    ...
    .chip{display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;background:rgba(209,165,69,.16);border:1px solid rgba(209,165,69,.22);color:rgba(120,86,18,1);font-weight:900;font-size:.82rem}
    .code{font-weight:900;font-size:2.6rem;line-height:1;margin:10px 0 8px;color:rgba(15,23,42,.88)}
    h1{margin:10px 0 6px;font-size:1.2rem;color:var(--t)}
    p{margin:0;color:rgba(15,23,42,.65)}
    .actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:16px}
    .btn{border:0;cursor:pointer;height:44px;padding:0 14px;border-radius:14px;font-weight:900;display:inline-flex;align-items:center;justify-content:center;text-decoration:none}
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <div class="body">
        <div class="chip">Sistem Mengalami Gangguan</div>
        <div class="code">Terjadi Kesalahan</div>
