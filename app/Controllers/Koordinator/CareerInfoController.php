<?php
/**
 * File Path: app/Controllers/Koordinator/CareerInfoController.php
 *
 * Career Info Controller (Koordinator BK)
...
class CareerInfoController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('koordinator/career/index', $data);
    }
     ...
     * URL: /koordinator/career-info/student-choices
     */
    public function studentChoices()
    {
        ...
        return view('koordinator/career/student_choices', $data);
    }
    ...
    public function createCareer()
    {
        ...
        return view('koordinator/career/form_career', $data);
    }
    ...
    public function storeCareer()
    {
        ...
        return redirect()->to(route_to('koordinator.career.index') . '?tab=careers')
    ...
    public function showCareer(int $id)
    {
        ...
        return view('koordinator/career/detail_career', [
            'career'  => $career,
            'backUrl' => route_to('koordinator.career.index') . '?tab=careers',
        ]);
    }
    ...
    public function universities()
    {
        ...
        return redirect()->to(site_url('koordinator/career-info') . '?' . http_build_query($qs));
    }
    ...
    public function createUniversity()
    {
        ...
        return view('koordinator/career/form_university', $data);
    }
    ...
    public function storeUniversity()
    {
        ...
        return redirect()->to(route_to('koordinator.university.index') . '?tab=universities')
    ...
    public function editUniversity(int $id)
    {
        ...
        return view('koordinator/career/form_university', ['uni' => $uni, 'mode' => 'edit']);
    }
    ...
    public function showUniversity(int $id)
    {
        ...
        return view('koordinator/career/detail_university', [
            'university' => $uni,
            'backUrl'    => route_to('koordinator.university.index') . '?tab=universities',
        ]);
    }
