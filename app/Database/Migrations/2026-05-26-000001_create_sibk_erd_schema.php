...
CREATE TABLE students (
    ...
    status ENUM('Aktif', 'Alumni', 'Pindah', 'Keluar') NOT NULL DEFAULT 'Aktif',
    total_violation_points INT NOT NULL DEFAULT 0,
    created_at DATETIME NULL,
    updated_at DATETIME NULL,
    deleted_at DATETIME NULL,
...
CREATE TABLE violation_categories (
    ...
    severity_level ENUM('Ringan', 'Sedang', 'Berat') NOT NULL DEFAULT 'Ringan',
    ...
    updated_at DATETIME NULL,
    deleted_at DATETIME NULL,
    INDEX idx_violation_categories_severity (severity_level),
    INDEX idx_violation_categories_active (is_active)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL,
            <<<'SQL'
CREATE TABLE violations (
    ...
    status ENUM('Dilaporkan', 'Dalam Proses', 'Selesai', 'Dibatalkan') NOT NULL DEFAULT 'Dilaporkan',
    ...
    INDEX idx_violations_category_id (category_id),
    INDEX idx_violations_reported_by (reported_by),
    INDEX idx_violations_handled_by (handled_by),
    INDEX idx_violations_status (status),
    INDEX idx_violations_date (violation_date),
    CONSTRAINT fk_violations_student FOREIGN KEY (student_id) REFERENCES students(id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_violations_category FOREIGN KEY (category_id) REFERENCES violation_categories(id) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT fk_violations_reported_by FOREIGN KEY (reported_by) REFERENCES users(id) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT fk_violations_handled_by FOREIGN KEY (handled_by) REFERENCES users(id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL,
            <<<'SQL'
CREATE TABLE sanctions (
    ...
    description TEXT NOT NULL,
    status ENUM('Dijadwalkan', 'Sedang Berjalan', 'Selesai', 'Dibatalkan') NOT NULL DEFAULT 'Dijadwalkan',
    ...
    parent_acknowledged_at DATETIME NULL,
    documents TEXT NULL,
    notes TEXT NULL,
    created_at DATETIME NULL,
    updated_at DATETIME NULL,
    deleted_at DATETIME NULL,
    INDEX idx_sanctions_violation_id (violation_id),
    INDEX idx_sanctions_assigned_by (assigned_by),
    INDEX idx_sanctions_verified_by (verified_by),
    INDEX idx_sanctions_status (status),
    CONSTRAINT fk_sanctions_violation FOREIGN KEY (violation_id) REFERENCES violations(id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_sanctions_assigned_by FOREIGN KEY (assigned_by) REFERENCES users(id) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT fk_sanctions_verified_by FOREIGN KEY (verified_by) REFERENCES users(id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL,
            <<<'SQL'
CREATE TABLE violation_submissions (
    ...
    status ENUM('Diajukan', 'Ditinjau', 'Ditolak', 'Diterima', 'Dikonversi') NOT NULL DEFAULT 'Diajukan',
    handled_by INT UNSIGNED NULL,
    handled_at DATETIME NULL,
    review_notes TEXT NULL,
    converted_violation_id INT UNSIGNED NULL,
    created_at DATETIME NULL,
    updated_at DATETIME NULL,
    deleted_at DATETIME NULL,
    ...
    INDEX idx_violation_submissions_category_id (category_id),
    ...
    CONSTRAINT fk_violation_submissions_category FOREIGN KEY (category_id) REFERENCES violation_categories(id) ON UPDATE CASCADE ON DELETE SET NULL,
    ...
    CONSTRAINT fk_violation_submissions_converted FOREIGN KEY (converted_violation_id) REFERENCES violations(id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL,
            <<<'SQL'
