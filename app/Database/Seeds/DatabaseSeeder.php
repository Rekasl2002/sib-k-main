...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedConsultationComplaints(string $now): void
    {
        $this->insertRows('consultation_complaints', [
            ...
            ['id' => 4, 'reporter_type' => 'student', 'reporter_user_id' => 9, 'subject_student_id' => 2, 'request_type' => 'Pengaduan', 'category' => 'Relasi teman', 'title' => 'Siswa meminta bantuan menyelesaikan konflik teman', 'description' => 'Siswa mengisi pengaduan karena merasa perlu mediasi dengan teman sekelas.', 'occurred_at' => '2026-06-08 12:30:00', 'location' => 'Koridor kelas X IPA C', 'priority' => 'Sedang', 'status' => 'Diajukan', 'privacy_level' => 'Rahasia BK', 'visible_to_homeroom' => 0, 'assigned_to_user_id' => 3, 'created_at' => '2026-06-08 13:10:00', 'updated_at' => $now],
        ]);
    ...
    private function seedCareerAndUniversity(string $now): void
    {
        $this->insertRows('career_options', [
            ['id' => 1, 'title' => 'Pengembang Perangkat Lunak', 'sector' => 'Teknologi Informasi', 'min_education' => 'D3/S1', 'description' => 'Membangun aplikasi web, mobile, dan sistem informasi.', 'required_skills' => json_encode(['Logika', 'Pemrograman', 'Kolaborasi']), 'pathways' => 'Belajar dasar pemrograman, membuat portofolio, mengikuti magang.', 'avg_salary_idr' => 7500000, 'demand_level' => 9, 'external_links' => json_encode([['label' => 'Dicoding', 'url' => 'https://www.dicoding.com']]), 'is_active' => 1, 'created_by' => 4, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 2, 'title' => 'Konselor Pendidikan', 'sector' => 'Pendidikan', 'min_education' => 'S1', 'description' => 'Membantu siswa memahami potensi dan mengambil keputusan pendidikan.', 'required_skills' => json_encode(['Empati', 'Komunikasi', 'Observasi']), 'pathways' => 'S1 BK/Psikologi, praktik lapangan, dan pengembangan kompetensi konseling.', 'avg_salary_idr' => 5000000, 'demand_level' => 7, 'is_active' => 1, 'created_by' => 3, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'title' => 'Perawat', 'sector' => 'Kesehatan', 'min_education' => 'D3', 'description' => 'Memberikan layanan keperawatan di fasilitas kesehatan.', 'required_skills' => json_encode(['Ketelitian', 'Empati', 'Manajemen waktu']), 'pathways' => 'D3/S1 Keperawatan, uji kompetensi, praktik klinis.', 'avg_salary_idr' => 5200000, 'demand_level' => 8, 'is_active' => 1, 'created_by' => 3, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 4, 'title' => 'Guru dan Tenaga Pendidikan', 'sector' => 'Pendidikan', 'min_education' => 'S1', 'description' => 'Mengajar, membimbing, dan mengembangkan kegiatan pendidikan.', 'required_skills' => json_encode(['Komunikasi', 'Manajemen kelas', 'Kesabaran']), 'pathways' => 'S1 Pendidikan, PPG, dan praktik mengajar.', 'avg_salary_idr' => 4800000, 'demand_level' => 6, 'is_active' => 1, 'created_by' => 5, 'created_at' => $now, 'updated_at' => $now],
        ]);

        $this->insertRows('university_info', [
            ['id' => 1, 'university_name' => 'Institut Teknologi Bandung', 'alias' => 'ITB', 'accreditation' => 'Unggul', 'location' => 'Bandung', 'website' => 'https://www.itb.ac.id', 'description' => 'Perguruan tinggi negeri berfokus pada sains, teknologi, seni, dan desain.', 'faculties' => json_encode(['STEI', 'FTI', 'FMIPA']), 'programs' => json_encode([['name' => 'Informatika', 'degree' => 'S1'], ['name' => 'Sistem dan Teknologi Informasi', 'degree' => 'S1']]), 'admission_info' => 'SNBP, SNBT, dan seleksi mandiri.', 'tuition_range' => 'UKT bertingkat', 'scholarships' => json_encode(['KIP Kuliah', 'Beasiswa alumni']), 'contacts' => json_encode(['email' => 'humas@itb.ac.id']), 'is_active' => 1, 'created_by' => 4, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 2, 'university_name' => 'Universitas Pendidikan Indonesia', 'alias' => 'UPI', 'accreditation' => 'Unggul', 'location' => 'Bandung', 'website' => 'https://www.upi.edu', 'description' => 'Perguruan tinggi negeri dengan kekuatan utama pada bidang pendidikan.', 'faculties' => json_encode(['FIP', 'FPIPS', 'FPMIPA']), 'programs' => json_encode([['name' => 'Bimbingan dan Konseling', 'degree' => 'S1'], ['name' => 'Pendidikan Guru', 'degree' => 'S1']]), 'admission_info' => 'SNBP, SNBT, dan seleksi mandiri.', 'tuition_range' => 'UKT bertingkat', 'scholarships' => json_encode(['KIP Kuliah']), 'is_active' => 1, 'created_by' => 3, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'university_name' => 'Universitas Padjadjaran', 'alias' => 'UNPAD', 'accreditation' => 'Unggul', 'location' => 'Sumedang', 'website' => 'https://www.unpad.ac.id', 'description' => 'Perguruan tinggi negeri dengan pilihan program kesehatan, sosial, dan sains.', 'faculties' => json_encode(['FK', 'FIK', 'FMIPA']), 'programs' => json_encode([['name' => 'Keperawatan', 'degree' => 'S1'], ['name' => 'Psikologi', 'degree' => 'S1']]), 'admission_info' => 'SNBP, SNBT, dan seleksi mandiri.', 'tuition_range' => 'UKT bertingkat', 'scholarships' => json_encode(['KIP Kuliah', 'Beasiswa prestasi']), 'is_active' => 1, 'created_by' => 3, 'created_at' => $now, 'updated_at' => $now],
        ]);
